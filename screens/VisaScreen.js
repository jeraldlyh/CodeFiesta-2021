...
function VisaScreen({ navigation }) {
    ...
    return (
        <View style={tailwind("flex flex-col w-full h-full p-3 items-center")}>
            ...
            <Button onPress={() => setActiveIndex(1)} text="I have a visa" backgroundColor={isActive(1) ? "#FE904B": "#e3e3e3"} textColor={isActive(1) ? "#FFF" : "#000"} />

            <View style={tailwind("mt-6")}/>
            <Button onPress={() => setActiveIndex(2)} text="I do not have a visa" backgroundColor={isActive(2) ? "#FE904B": "#e3e3e3"} textColor={isActive(2) ? "#FFF" : "#000"} />
