        ...
        <>
            <Swiper autoplay={true} showsPagination={false}>
                <ImageBackground source={require("../../assets/welcome/1.webp")} style={styles.image}>
                    <Text style={[tailwind("flex flex-col text-white self-end px-9 pb-4 font-normal"), {fontSize: 28, marginTop:200}]}>One<Text style={[tailwind("font-extrabold"), {color:'#FB724C'}]}>Stop</Text></Text>
