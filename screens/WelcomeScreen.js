        ...
        <>
            <Swiper autoplay={true} showsPagination={false}>
                <ImageBackground source={require("../assets/welcome/1.webp")} style={styles.image}>
                    <Text style={[tailwind("flex flex-col text-white self-end px-9 pb-4 font-normal"), {fontSize: 21, marginTop:200}]}>One<Text style={tailwind("font-extrabold")}>Stop</Text></Text>
